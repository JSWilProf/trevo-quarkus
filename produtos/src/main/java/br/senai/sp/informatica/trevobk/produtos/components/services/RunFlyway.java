package br.senai.sp.informatica.trevobk.produtos.components.services;
...
public class RunFlyway {
    ...
    public void runFlywayMigration(@Observes StartupEvent event) {
        if (runMigration) {
            ...
            DataSource ds = Flyway.configure()
                .validateOnMigrate(true)
                .validateMigrationNaming(true)
                .dataSource(datasourceUrl, datasourceUsername, datasourcePassword).getDataSource();
